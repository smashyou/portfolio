          ...
          <ul className="service__list">
            ...
            <li>
              ...
              <ul className="service__sublist">
                ...
                <li>
                  <BiCheckboxSquare className="service__sublist-icon" />
                  <p>Community management (responding to comments, messages)</p>
                </li>
                <li>
                  <BiCheckboxSquare className="service__sublist-icon" />
            ...
            <li>
              ...
              <ul className="service__sublist">
                ...
                <li>
                  <BiCheckboxSquare className="service__sublist-icon" />
                  <p>
                    Designing remarketing funnels to recover abandoned carts and
                    boost sales
                  </p>
                </li>
                <li>
                  <BiCheckboxSquare className="service__sublist-icon" />
                  <p>Syncing product catalogs with social commerce platforms</p>
                </li>
              </ul>
            </li>
